  ...
  export default function Features() {
    ...
    return (
      <div className=" p-6 md:p-12" id="features">
        {" "}
        <p className="text-3xl lg:text-5xl  text-center font-semibold capitalize mb-10 ">
          What we offer
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-3xl  bg-[#d1eb73]  border  p-6 transition-all duration-300 hover:shadow-2xl hover:shadow-white/20 hover:-translate-y-1"
            >
